 ...
 * copiar. Los dos primeros párrafos son datos confirmados por Antonio (más
 * de 15 años, zona, tipo de trabajos); el tercero y el cuarto son ya voz de
 * marca de relleno, no hechos nuevos. Si algo de esto no encaja, mejor que
 * lo diga Emilio que seguir puliéndolo a ciegas.
 */
